...
namespace Ihc.Controllers
{
    public class ContactoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Relacion,Entidad,Area,Telefono,Correo,Descripcion")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Relacion,Entidad,Area,Telefono,Correo,Descripcion")] Contacto contacto)
        {
            if (id != contacto.Id)
            {
                return NotFound();
