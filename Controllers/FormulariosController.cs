...
namespace Ihc.Controllers
{
    public class FormulariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreFormulario,CodigoFormulario,Archivo")] Formulario formulario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreFormulario,CodigoFormulario,Archivo")] Formulario formulario)
        {
            if (id != formulario.Id)
            {
                return NotFound();
